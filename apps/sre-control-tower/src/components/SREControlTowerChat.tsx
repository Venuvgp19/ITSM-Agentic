          ...
          <div className="p-3 bg-black/20 border-t border-white/[0.07] flex items-end space-x-2">
            <div className="flex-1 relative focus-within:shadow-[0_0_0_1px_rgba(6,182,212,0.4)] rounded-xl transition-shadow">
              <textarea
                ...
                rows={1}
                disabled={loading}
                className="focus-ring w-full bg-white/[0.04] border border-white/10 rounded-xl px-3.5 py-2.5 text-[13px] text-white placeholder-slate-500 focus:border-cyan-500/50 resize-none max-h-24 custom-scrollbar disabled:opacity-50 transition-colors"
              />
            </div>
            <button
              onClick={() => handleSend()}
