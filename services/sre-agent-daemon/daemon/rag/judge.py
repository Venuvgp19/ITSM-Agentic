...
def verify_rag_match_intent_with_llm(short_desc, desc, sop_number, sop_title, sop_commands):
    ...
    try:
        prompt = (
            ...
            "Candidate SOP: 'Fix Nexacore Application 404 Error on Cluster Node', commands: inspect web directory /var/www/html or app path, check symlinks, restore missing index or static assets, verify curl http://localhost:8080 returns 200 OK.\n"
